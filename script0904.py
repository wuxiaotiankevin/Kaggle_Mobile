...
param_grid = {'n_estimators':[1000, 2000, 3000], 'n_jobs':[3], 
...
savetxt('predict_random_forest.csv', predict_rf, delimiter=',', fmt='%f')
...
#%%
# Simple blending
predict_blending = (predict_xgboost + predict_logistic + predict_keras + predict_rf)/4
